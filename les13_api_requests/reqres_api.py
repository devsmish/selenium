"""Выполнить API-запрос с помощью библиотеки Requests
Используя библиотеку requests, выполнить GET-запрос к https://reqres.in/api/users/2 и обработать ответ.
Требования
Отправить GET-запрос к API https://reqres.in/api/users/2.
Проверить, что запрос выполнен успешно (ожидаемый статус-код 200 OK).
Извлечь JSON-данные из ответа и вывести следующую информацию:
ID пользователя
Имя (first_name)
Фамилию (last_name)
Email
Аватар (avatar) (ссылка на изображение."""
import requests
import pytest

BASE_URL = "https://reqres.in/api/users"

x_api_key = "free_user_3EIo0vau3uMxWUCUkLtYyCvXnex"
